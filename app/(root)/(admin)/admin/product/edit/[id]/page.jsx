...
const EditProduct = ({params}) => {
  ...
  useEffect(() => {
    if(getProduct && getProduct.success) {
        ...
        if(product.media){
          const media = product.media.map((m) => ({_id: m._id, url: m.secure_url }))
      ...
      <Card className="rounded shadow-sm">
        <CardHeader className="pt-3 px-3 border-b [.border-b]:pb-2">
          <div className="flex justify-between items-center">
            <h4 className="uppercase font-semibold text-xl">Edit Product</h4>
            <Link href={ADMIN_PRODUCT_SHOW} className="cursor-pointer">
